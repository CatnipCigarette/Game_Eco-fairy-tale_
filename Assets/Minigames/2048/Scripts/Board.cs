...
public class Board : MonoBehaviour
{
    ...
    private void CreateBlock(int x, int y)
    {
        ...
        // Change this part to assign the image sprite to the Image component of the realNodeObj
        ...
        realNodeObj.GetComponent<Image>().sprite = nodeObj.image; // Add this line to set the image sprite

        // Add this condition to set the initial image based on the cell's value
        if (nodeObj.value != 0)
        {
            nodeObj.UpdateImage(nodeObj.value);
        }
        else
        {
            nodeObj.UpdateImage(0);
        }
    }
    ...
    public void Combine(Node from, Node to)
    {
        ...
        // Update the displayed image of the "to" cell
        if (to.realNodeObj != null)
        {
            to.realNodeObj.UpdateImage(to.value.Value); // Convert to.value to int
        }
    }
    ...
    public void Move(Node from, Node to)
    {
        ...
        if (from.realNodeObj != null)
        {
            ...
            if (from.realNodeObj != null)
            {
                ...
                from.realNodeObj = null;
                int value = to.value.HasValue ? to.value.Value : 0;
                to.realNodeObj.UpdateImage(value);
            }
        }
